...
def use(req_per_con: int, is_inf: str, url: str, session: int, use_post: bool = False, use_random_headers: bool = True, use_random_params: bool = True, show_header: bool = True):
