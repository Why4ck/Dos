...
A simple tool for testing DoS attacks (for educational purposes only!)

## Features
- Dos attack with multi session and change size of request
...
ключевое словно - why4ck, аргументы :
1) --url ССЫЛКА
2) 